...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">IMAM MUSTARI, SE</th>
                    <td>LURAH PEJAGAN</td>
                    <td>DESA PEJAGAN</td>

                </tr>
                <tr>
                    <th scope="row">LILIK TUFAILAH, SE</th>
                    <td>SEKRETARIS KEL. PEJAGAN</td>
                    <td>DESA PEJAGAN</td>

                </tr>
                <tr>
                    <th scope="row">MUFLIH PANCA WIJAYA, SE</th>
                    <td>KASI PEMERINTAHAN KEL. PEJAGAN</td>
                    <td>DESA PEJAGAN</td>

                </tr>
                <tr>
                    <th scope="row">RUSDIYANTO, SE</th>
                    <td>KASI PMD KEL. PEJAGAN</td>
                    <td>DESA PEJAGAN</td>
