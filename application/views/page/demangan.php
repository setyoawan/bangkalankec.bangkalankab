...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">ARDI PERDHANA, S.IP</th>
                    <td>LURAH DEMANGAN</td>
                    <td>DESA DEMANGAN</td>

                </tr>
                <tr>
                    <th scope="row">ALVINA RISQIA AFIF, SAP</th>
                    <td>SEKRETARIS KEL. DEMANGAN</td>
                    <td>DESA DEMANGAN</td>

                </tr>
                <tr>
                    <th scope="row">KURNIATI HARTINI, SAP</th>
                    <td>KASI PEMERINTAHAN KEL. DEMANGAN</td>
                    <td>DESA DEMANGAN</td>

                </tr>
                <tr>
                    <th scope="row">FATHOR RACHMAN, SE</th>
                    <td>KASI PMD KEL. DEMANGAN</td>
                    <td>DESA DEMANGAN</td>

                </tr>
                <tr>
                    <th scope="row">ERNIANSYAH ATS TSULUTS, SE</th>
                    <td>KASI KESMAS KEL. DEMANGAN</td>
                    <td>DESA DEMANGAN</td>
