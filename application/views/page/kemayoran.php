...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">MUSTOFA, SE. MM</th>
                    <td>LURAH KEMAYORAN</td>
                    <td>DESA KEMAYORAN</td>

                </tr>
                <tr>
                    <th scope="row">DANI KUSUMA CIPTA, SH</th>
                    <td>KASI PEMERINTAHAN KEL. KEMAYORAN</td>
                    <td>DESA KEMAYORAN</td>

                </tr>
                <tr>
                    <th scope="row">IKE KUSUMA HARYANI, A.Md</th>
                    <td>KASI PMD KEL. KEMAYORAN</td>
                    <td>DESA KEMAYORAN</td>

                </tr>
                <tr>
                    <th scope="row">ISWAHYUNI SUSANTI, SE</th>
                    <td>KASI KESMAS KEL. KEMAYORAN</td>
                    <td>DESA KEMAYORAN</td>
