...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">LUKMAN HAKIM, S.STP. MM</th>
                    <td>LURAH BANCARAN</td>
                    <td>DESA BANCARAN</td>

                </tr>
                <tr>
                    <th scope="row">MOHAMMAD ANAS, SE</th>
                    <td>SEKRETARIS KEL. BANCARAN</td>
                    <td>DESA BANCARAN</td>

                </tr>
                <tr>
                    <th scope="row">MOHAMMAD RACHMAN, SE</th>
                    <td>KASI PEMERINTAHAN KEL. BANCARAN</td>
                    <td>DESA BANCARAN</td>

                </tr>
                <tr>
                    <th scope="row">HIKMAWATI, SE</th>
                    <td>KASI PMD KEL. BANCARAN</td>
                    <td>DESA BANCARAN</td>

                </tr>
                <tr>
                    <th scope="row">SUDARWATI, SE</th>
                    <td>KASI KESMAS KEL. BANCARAN</td>
                    <td>DESA BANCARAN</td>
