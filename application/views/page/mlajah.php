...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">SAWARI, SH</th>
                    <td>LURAH MLAJAH</td>
                    <td>DESA MLAJAH</td>

                </tr>
                <tr>
                    <th scope="row">SITI FATIRAH, Spd</th>
                    <td>SEKRETARIS KEL. MLAJAH</td>
                    <td>DESA MLAJAH</td>

                </tr>
                <tr>
                    <th scope="row">ABDUL GOFAR, SE</th>
                    <td>KASI PEMERINTAHAN KEL. MLAJAH</td>
                    <td>DESA MLAJAH</td>

                </tr>
                <tr>
                    <th scope="row">ROSIDI, SE</th>
                    <td>KASI PMD KEL. MLAJAH</td>
                    <td>DESA MLAJAH</td>

                </tr>
                <tr>
                    <th scope="row">JAUHAN ATS TSANI, SE</th>
                    <td>KASI KESMAS KEL. MLAJAH</td>
                    <td>DESA MLAJAH</td>
