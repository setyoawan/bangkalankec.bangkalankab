...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">HAIRIS ZAMAN</th>
                    <td>KEPALA DESA</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">SUPRIYADI</th>
                    <td>SEKRETARIS DESA</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">USWATUN HASANAH</th>
                    <td>KASI PEMERINTAHAN</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">MAHFUD</th>
                    <td>KASI PELAYANAN DAN KESMAS</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">SITI MARYAM</th>
                    <td>KAUR KEUANGAN</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">AGUS RIANTO</th>
                    <td>KAUR UMUM DAN PERENCANAAN</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">MOH TIWAR</th>
                    <td>KADUS BARAT EMBONG</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">MULYADI HERMAWAN</th>
                    <td>KADUS TIMUR EMBONG</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">ABD. GHONI</th>
                    <td>KADUS TIMUR SUNGAI</td>
                    <td>DESA SABIYAN</td>

                </tr>
                <tr>
                    <th scope="row">MOH SABIRI</th>
                    <td>KADUS BANJAR SERPANG</td>
                    <td>DESA SABIYAN</td>
